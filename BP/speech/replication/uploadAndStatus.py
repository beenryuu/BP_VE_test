...
def train(appid, token, audio_path, spk_id):
    ...
    data = {"appid": appid, "speaker_id": spk_id, "audios": audios, "source": 2,"language": 2, "model_type": 1}
...
if __name__ == "__main__":
    ...
    token = os.environ['BP_SPEECH_APP_TOKEN']
    spk_id = os.environ['BP_SPEECH_VOICE_ID']
    audio_path = os.environ['REPL_AUDIO_FILE_PATH']
