...
AK = os.environ['BP_ACCESS_KEY']
SK = os.environ['BP_SECRET_KEY']
...
#    print(response_body)
    ...
    voice_url = os.environ['OMNI_VOICE']
    ...
    response_body = request("POST", now, {}, {}, AK, SK, "CVSubmitTask", json.dumps(req_body))
    print(response_body)